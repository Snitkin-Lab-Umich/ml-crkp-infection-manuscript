# Plot infection and source on tree (Figure 1)
...
cols_mat = c('black','white','#2b8cbe','#feb24c','coral3')
...
thm = plot_grid(leg,NULL,th,nrow=1,rel_widths = c(0.2,-0.15,0.8), rel_heights = c(0.1,0.9,0.9), greedy = T)
ggsave(thm,filename='results/figures/heatmap/tree_inf_src.pdf',bg='transparent',width=6,height=5)
