# Plot missing kfoC and panISa results on tree (Figure S9)
library(ape)
library(phytools)
library(ggtree)
library(ggplot2)
...
source('../../../../bin_group/pipeline/Github/scripts/panISa_parser_functions.R')
...
pdf('results/figures/heatmap/tree_kleb_panisa.pdf')
